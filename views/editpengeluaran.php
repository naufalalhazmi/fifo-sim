            ...
            <div id="layoutSidenav_content">
                ...
                ?>
                    <div class="container-fluid px-4">
                        <h1 class="my-4 text-center">Edit Pengeluaran Obat</h1>
                        <div class="col-md-8 m-auto card p-5 shadow -3 mb-5 bg-body rounded">
                            <form enctype="multipart/form-data" action="../proses/editpengeluaran.php" method="post">
                                <input type="hidden" name="id" value="<?= $id ?>">                                                    
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Tujuan</label>
                                    <input name="tujuan" type="text" class="form-control id=exampleFormControlInput1" value="<?= $data['tujuan'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Harga</label>
                                    <input name="harga" type="text" class="form-control id=exampleFormControlInput1" value="<?= $data['harga'] ?>">
                                </div>
                                <div class="mb-3">
