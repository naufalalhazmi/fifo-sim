            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="my-4 text-center">Pengeluaran Obat</h1>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="get" action="pengeluaran.php">
                                    <div class="mb-3">
                                        ...
                                        <a href="pengeluaran.php" class="btn btn-danger">Hapus Filter</a>
                                    </div>
                                </form>
                                <div id="pagination-container" class="d-flex mb-3">
                                    <a href="tambahpengeluaran.php" class="btn btn-primary ms-2">Tambah Data</a>
                                </div>
                                <table id="datatablesSimple" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $data['hargatot'] ?></td>
                                            <td>
                                                <a href='../proses/downloaddokumen.php?filename=<?= $data['dokumen'] ?>'><?= $data['dokumen'] ?></a>
                                            </td>                                          
                                            <td>
                                                <ul class="list-inline d-flex justify-content-evenly">
                                                    <li><a href="./editpengeluaran.php?id=<?= $data['id'] ?>" class="btn btn-success">Edit</a></li>
                                                    <li>
                                                        <form action="../proses/deletepengeluaran.php" method="post">
